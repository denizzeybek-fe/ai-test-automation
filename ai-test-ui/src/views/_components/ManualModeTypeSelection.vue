<template>
  <div class="pt-6 border-t border-gray-200 dark:border-gray-700 space-y-4">
    ...
    <p class="text-xs text-gray-500 dark:text-gray-400">
      Review the detected analytics types above. You can change them if needed, then click "Generate Prompt" to get the prompt for Claude.
    </p>
  </div>
</template>
