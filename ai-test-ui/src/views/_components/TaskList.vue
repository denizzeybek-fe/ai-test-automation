...
<template>
  <Card title="Recent Tasks" padding="none">
    <!-- Search Bar -->
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
      ...
      />
      <p v-if="searchQuery && tasks.length === 0" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
    ...
    <div class="max-h-[400px] overflow-y-auto divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div v-if="tasks.length === 0" class="p-8 text-center">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by running your first task.</p>
      </div>
